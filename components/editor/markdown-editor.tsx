...
import { Eye, Edit, Columns, Download, Save, PanelLeftClose, PanelLeft, Maximize2, Minimize2, FileText, ChevronUp, ChevronDown, History } from "lucide-react";
...
export function MarkdownEditor({
  ...
  // Update content when initialContent changes (e.g., when restoring a version)
  useEffect(() => {
